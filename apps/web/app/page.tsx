...
export default function Home() {
  ...
  async function resetDemo() { localStorage.removeItem(demoKey); setSelectedLotId(initialLot.id); setDraftLot(draftLotTemplate); setQuoteInput(initialQuote); setQuote(null); setDecision(null); setOrderStatus(null); setEscrow(null); setNotice("Demo reset. Start by listing a farmer lot."); setRole("farmer"); setView("workspace"); await refreshCatalog(); }
